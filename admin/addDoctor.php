...
<?php include('header.php'); ?>
	...
	<div class="recipient_reg" style="background-color:#272327;">
		<h3 class="text-center" style="background-color:#272327;color: #fff; margin-left: 50%">Add New Doctor</h3>
			...
			<?php
						...
						if(isset($_POST['submit'])){
							...
							if ($conn->query($sql) === TRUE) {
							    echo "<script>alert('New Doctor Has been Added Successfully by admin!');</script>";
							} else {
