	...
	<div class="contactus"  style="background-color:#fff;">
		...
		<div class="main_content">
			<div class="col-md-6" style="border-right: 2px solid black;">
				<article>
					<h2>Md. Emran Sheikh <h2><h4>Studies B.Sc in Software Engineering</h4>
							<h5>Daffodil International University, Dhaka,Bangladesh</h5>
						<p> https://www.facebook.com/mohammad.imransheikh.SWE <br>
							https://www.instagram.com/md_imran_sheikh/ <br>
							cell: +88 01838235450</p><br>
				</article>
			</div>
			<div class="col-md-6">
